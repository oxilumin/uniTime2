...
public class StaticFeatures {
    ...
    private static String FeatureCalculationForSingleFile(String iPathname, ExLocalSearchFeatures localSearchFeatures) throws Exception {
        ...
        str.append(String.valueOf(localSearchFeatures.getBestLocalSearchScore()) + ",");

        str.append(String.valueOf(localSearchFeatures.getMinScoreElement().getAssignedVariables()) + ",");
        str.append(String.valueOf(localSearchFeatures.getMinScoreElement().getIteration()) + ",");
        str.append(String.valueOf(localSearchFeatures.getMinScoreElement().getScore()) + ",");
        str.append(String.valueOf(localSearchFeatures.getMinScoreElement().getTotalVariables()) + ",");

        str.append(String.valueOf(localSearchFeatures.getMaxScoreElement().getAssignedVariables()) + ",");
        str.append(String.valueOf(localSearchFeatures.getMaxScoreElement().getIteration()) + ",");
        str.append(String.valueOf(localSearchFeatures.getMaxScoreElement().getScore()) + ",");
        str.append(String.valueOf(localSearchFeatures.getMaxScoreElement().getTotalVariables()) + ",");

        str.append(String.valueOf(localSearchFeatures.getMedianScoreElement().getAssignedVariables()) + ",");
        str.append(String.valueOf(localSearchFeatures.getMedianScoreElement().getIteration()) + ",");
        str.append(String.valueOf(localSearchFeatures.getMedianScoreElement().getScore()) + ",");
        str.append(String.valueOf(localSearchFeatures.getMedianScoreElement().getTotalVariables()));
    ...
    public static ExLocalSearchFeatures GetLocalSearchFeatures(String input) {
...
*/
        ExItcTest.initLogger("log.log");

        FileWriter fw = new FileWriter("C:/Data/OlyaMasterThesis/Instances/infoSetsNew1_LS2.csv");

        for (int i = 0; i <= 241; i++) {
            String str = String.format("C:/Olga/MasterThesis/Instances/art%03d.exam", i);

            ExLocalSearchFeatures localSearchFeatures = GetLocalSearchFeatures(str);

            fw.write(FeatureCalculationForSingleFile(str, localSearchFeatures) + "\n");
